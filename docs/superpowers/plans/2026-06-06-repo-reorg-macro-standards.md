...
**Tone rule (applies to every file this plan writes):** no em dashes or en dashes, no "e.g."/"i.e."/"etc.", nothing that reads as machine-generated, no emoji. After writing each file, a grep step confirms compliance.
...
- No "generated by" lines and no references to code-generation tools.
...
(no em dashes, no "e.g.", and nothing that reads as machine-generated).
